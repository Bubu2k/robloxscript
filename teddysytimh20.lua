...
local File_Name    = _vX4("45 63 6c 69 70 73 65 4b e1 b9 a3 43 61 63 68 65 2e 74 78 74")
local MainAPI_URL  = _vX4("68 74 74 70 73 3a 2f 2f 72 61 77 2e 67 69 74 68 75 62 75 73 65 72 63 6f 6e 74 65 6e 74 2e 63 6f 6d 2f 54 65 64 64 79 73 65 65 74 69 6e 6b 2f 48 61 69 64 65 70 7a 61 69 2f 72 65 66 73 2f 68 65 61 64 73 2f 6d 61 69 6e 2f 6d 61 69 6e 2e 6c 75 61")
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH (ĐÃ BẢO MẬT URL)
---------------------------------------------------------
