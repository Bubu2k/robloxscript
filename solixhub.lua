...
-- Khởi tạo cấu hình tài nguyên hệ thống (Đã áp dụng Hex tĩnh để ẩn thông tin)
...
local MainAPI_URL  = _vX4("68 74 74 70 73 3a 2f 2f 72 61 77 2e 67 69 74 68 75 62 75 73 65 72 63 6f 6e 74 65 6e 74 2e 63 6f 6d 2f 62 61 6f 38 6a 6c 2f 73 6f 6c 69 78 68 75 62 2f 6d 61 69 6e 2f 6c 6f 61 64 65 72")
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH (SOLIX HUB RUNNER)
---------------------------------------------------------
