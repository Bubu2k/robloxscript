--[[ 
    ...
    Cấu hình Script: Mới (Luarmor API)
]]
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH CỦA BẠN (ĐÃ CẬP NHẬT DY HUB)
---------------------------------------------------------
local function ExecuteMainScript()
    local loadSuccess, err = pcall(function()
        -- Thay đổi URL nạp script chính DY HUB tại đây
        loadstring(game:HttpGet('https://raw.githubusercontent.com/RealDYHUB/Main/refs/heads/main/Loader'))()
    end)
...
SubmitBtn.MouseButton1Click:Connect(function()
    ...
    if userKey == fetchedKey then
        ...
        -- Chạy script DY HUB chính sau khi qua Key System của bạn
        ExecuteMainScript()
    else
