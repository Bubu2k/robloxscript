--[[ 
    PREMIUM CYBERPUNK KEY SYSTEM 2026 - OBFUSCATED & SECURED
    Cấu hình Script: Chỉ sử dụng Key từ Server GitHub (Wishub API)
]]
...
local MainAPI_URL  = _vX4("68 74 74 70 73 3a 2f 2f 61 70 69 2e 77 69 73 68 75 62 2e 63 6c 6f 75 64 2f 66 69 6c 65 73 2f 6c 6f 61 64 65 72 73 2f 64 65 64 63 66 39 62 65 39 34 37 64 34 33 62 38 61 65 30 36 35 61 64 32 31 32 30 30 63 37 36 34 2e 6c 75 61")
...
---------------------------------------------------------
-- HÀM KÍCH HOẠT SCRIPT CHÍNH (WISHUB API)
---------------------------------------------------------
...
if fetchedKey and readfile and isfile and isfile(File_Name) then
    if readfile(File_Name) == fetchedKey then
        ExecuteMainScript()
        return 
    end
end
